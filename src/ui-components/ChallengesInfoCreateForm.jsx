...
import { createChallengesInfo } from "../graphql/mutations";
...
export default function ChallengesInfoCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setShortInfo(initialValues.ShortInfo);
    ...
    setAIBackgroundImage(initialValues.AIBackgroundImage);
    setErrors({});
  };
  const validations = {
    ProjectName: [],
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createChallengesInfo.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
